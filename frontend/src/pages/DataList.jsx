...
import { getPreAlertCompleteList } from '@api/PreAlert';
...
function DataList() {
    ...
    const PreAlertListQuery = useQuery({
        queryKey: ['CompleteDataList'],
        queryFn: async () => {
            const result = await getPreAlertCompleteList()
            return result
        },
    ...
    return (
        <>
            <ViewData showModal={getModalStatusView} token={''} display={'Viewing'}
