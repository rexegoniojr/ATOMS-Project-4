...
import { getForCDTList } from '@api/CDT';
...
function AssignDeclarant() {
    ...
    const ForCDTListQuery = useQuery({
        queryKey: ['ForCDTList'],
        queryFn: async () => {
            const result = await getForCDTList()
            return result
        },
    ...
    return (
        <>
            <ViewData showModal={getModalStatusView} token={token} display={'Assign'} selected={'CDT'}
...
export default AssignDeclarant